<nav class="clearfix">	
	<ul class="menu">
		...
		<li><h2>Reales</h2>
			<ul>
				<li><a title="Cartelera Cine 2" href="ejemplos/reales/cartelera.jsp" > Cartelera  </a></li>
		...
		<li><h2>Formularios</h2>
			<ul>
				...
				<li><a title="Controlador" href="ejemplos/formularios/controlador.jsp" > Controlador </a></li>
				<li><a title="Controlador Datos Personales" href="ejemplos/formularios/controlador_dp.jsp" >Controlador Datos Personales </a></li>
				<li><a title="datalist" href="ejemplos/formularios/datalist.jsp" > Datalist </a></li>
				<li><a title="progesymeter" href="ejemplos/formularios/progesymeter.jsp" > Proges y Meter </a></li>
			</ul>
		</li>
		<li><h2>Nuevas etiquetas HTML5</h2>
			<ul>
				...
				<li><a title="mark" href= "ejemplos/nuevas_etiquetas_html5/mark.jsp"> mark</a></li>
		...
		<li><h2>JavaScript</h2>
			<ul>
				...
				<li><h3>Mirar</h3>
					<ul>
						<li><a title="Ejemplo JavaScript" href="ejemplos/javascript/objetos/ejemplowindow.jsp" >Window</a></li>
						<li><a title="Ejemplo JavaScript" href="ejemplos/javascript/objetos/jorgewindow.jsp" >Ejemplo</a></li>
						<li><a title="Ejemplo JavaScript" href="ejemplos/javascript/objetos/ventanaclosed.jsp" >Closed</a></li>
					</ul>
				</li>
				<li><h3>Plugins</h3>
					<ul>
						...
						<li><a title="Ejemplo de switch vocal" href="ejemplos/javascript/ejemplosbasico/calculadoramia.jsp" >CalculadoraMia</a></li>
						<li><a title="Ejemplo de switch vocal" href= "ejemplos/javascript/ejemplosbasico/calculadorainternet.jsp">CalculadoraInternet</a></li>
					</ul>
				</li>
				<li><h3>TEST</h3>
					<ul>
